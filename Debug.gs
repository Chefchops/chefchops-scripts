...
function getPackSizeStandardTests_() {
	return [
		...
		},
		{
			packSize: "10-1.00pk",
			caseSize: "",
			expectedDisplayPackSize: "10x100pk",
			expectedPackQty: 1000,
			expectedBaseUnit: "each",
			expectedUnitPerPackCase: 1000,
		},
		{
		...
		},
		{
			packSize: "1-100x20p",
			caseSize: "",
			expectedDisplayPackSize: "1x100x20g",
			expectedPackQty: 1,
			expectedBaseUnit: "g",
			expectedUnitPerPackCase: 2000,
		},
		...
		},
		{
			packSize: "5-1..76kg",
			caseSize: "",
			expectedDisplayPackSize: "5x1.76kg",
			expectedPackQty: 5,
			expectedBaseUnit: "g",
			expectedUnitPerPackCase: 8800,
		},
		{
			packSize: "1-2000sac",
			caseSize: "",
